...
namespace HotelRoomsOperation.data
{
    public class HotelRommDBImple
    {
        ...
        public Int64 InsertHotelRooms(Int64 Hotel_Id, string RoomType, Int64 AvailableRooms, Int64 TotalRooms)
        {
        ...
        public HotelRooms SelectHotelRooms(Int64 Hotel_Id)
        {
            DatabaseProviderFactory dbfactory = new DatabaseProviderFactory();
            Database defaultdatabase = dbfactory.CreateDefault();
            Database database = dbfactory.Create(DBName);
            ...
            HotelRooms hotelroom = HotelRoomsTranslate.ParseHotelRooms(database.ExecuteDataSet(command));
           
            return hotelroom;
        }


        public Int64 UpdateHotelRooms(Int64 Hotel_Id, string RoomType)
        {
            DatabaseProviderFactory dbfactory = new DatabaseProviderFactory();
            Database defaultdatabase = dbfactory.CreateDefault();
            Database database = dbfactory.Create(DBName);
